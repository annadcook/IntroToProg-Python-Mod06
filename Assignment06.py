...
class IO:
    ...
    def output_error_messages(message: str, error: Exception = None):
        ...
        ChangeLog: (Who, When, What)
        ACook,3.4.2026,Created function
    ...
    @staticmethod
    def input_menu_choice(choice: str = menu_choice):
    ...
    def output_student_courses(student_data: list):
        """ This function displays the course each student is enrolled in
